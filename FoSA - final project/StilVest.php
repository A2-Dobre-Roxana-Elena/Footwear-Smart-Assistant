...
<div class="row">
    ...
    <form action="stilform.php" method="post">
      <ul>
        <li>Elegant
            <label class="switch">
                <input type="radio" name="stil" value="elegant">
                <span class="slider round"></span>
              </label>
        </li>
        <li>Office
            <label class="switch">
                <input type="radio" name="stil" value="office">
                <span class="slider round"></span>
              </label>
        </li>
        <li>Sportiv
            <label class="switch">
                <input type="radio" name="stil" value="sport">
                <span class="slider round"></span>
              </label>
        </li>
        <li>Home
            <label class="switch">
                <input type="radio" name="stil" value="home">
                <span class="slider round"></span>
              </label>
        </li>
      </ul>
      <input type="submit" name='submit' value="Salveaza categorie">
</form></div>
